exports.ServiceScreen = function(navigation) {
    ...
    var ServiceJobScreen = require('views/account/ServiceJobScreen').ServiceJobScreen;
    table.addEventListener('click', function() {
        navigation.open(new ServiceJobScreen(), { animated: true });
    });
