exports.PackagesScreen = function(navigation) {
    ...
    var PackageDetailsScreen = require('views/account/PackageDetailsScreen');
    table.addEventListener('click', function() {
        navigation.open(new PackageDetailsScreen(), { animated: true });
    });
